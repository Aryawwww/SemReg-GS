...
call conda run -n semreg-gs-v1 python scripts\audit_hssd_semantics.py --scene "%RAW%\scene_instance.json" --metadata "%RAW%\hssd_obj_semantics_condensed.csv" --output "%PROCESSED%\semantic_audit.json"
if errorlevel 1 exit /b 1
